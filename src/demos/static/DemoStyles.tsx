...
const styles = [
  ...
  { name: "Slash Sparse", bgStyles: stylesBgSlashSparse, description: "Sparse diagonal slash pattern with more spacing." },
  ...
  { name: "Grid Blueprint", bgStyles: stylesBgGridBlueprint, description: "Blueprint-style grid with major and minor lines." },
...
export function DemoStyles() {
  return (
    <div class="p-4">
      <h1 class="text-3xl font-bold mb-6">Background Styles Demo</h1>
      <div class="space-y-8">
        {styles.map((style) => (
          <section
            id={style.name.toLowerCase().replace(/\s+/g, "-")}
            class="max-w-screen-xl mx-auto min-h-64 flex flex-col items-center justify-center py-8 rounded-lg"
