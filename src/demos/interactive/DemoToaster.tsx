  ...
  return (
    <div>
      ...
      <div class="flex flex-wrap gap-4">
        <Button variant={buttonVariant.contrast} onClick={() => toastAdd({ title: "Default Toast" })}>
          Default
        </Button>
        <Button
...
function ToastWithDescriptionDemo() {
  return (
    <div>
      ...
      <div class="flex flex-wrap gap-4">
        <Button
          variant={buttonVariant.filledBlue}
          onClick={() =>
            toastAdd({
              title: "Information",
        ...
        <Button
          variant={buttonVariant.filledYellow}
          onClick={() =>
            toastAdd({
              title: "Warning",
  ...
  return (
    <div>
      ...
      <div class="space-y-4">
            ...
            toastAdd({
              ...
              children: (
                <div class="mt-2 flex gap-2">
                  ...
                  <Button size="sm" variant={buttonVariant.filledIndigo}>
                    View
                  </Button>
                </div>
              ),
        ...
        <p class="text-sm text-muted-foreground">Toasts can contain interactive elements like buttons.</p>
      </div>
    </div>
  )
}
