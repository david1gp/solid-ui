...
const DEFAULT_PROPS = Object.freeze({
  triggerEvents: "click", // click|pointerdown
  dataAttributeName: "data-popover-open",
  closeOnEscape: true,
  closeOnOutsideInteraction: true,
  computePositionOptions: {
    strategy: "absolute" as const,
    placement: "bottom-start" as const satisfies AlignedPlacement,
    middleware: [flip()],
...
/**
 * https://github.com/elite174/solid-simple-popover/tree/v2
 * https://github.com/elite174/solid-simple-popover/blob/v2/src/lib/index.tsx
 */
export const SimplePopover: ParentComponent<PopoverProps> = (initialProps) => {
